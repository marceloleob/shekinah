    ...
    <div class="settings_links_2 bg_white">
        <ul>
            ...
            <li class="{!! (request()->is('admin/adicionar-imoveis')) ? 'active' : '' !!}"><a href="{!! route('properties-advertise') !!}"><i class="fas fa-plus-circle"></i>Adicionar Imóvel</a></li>
        </ul>
        <ul>
            ...
            <li class="{!! (request()->is('admin/tipos-imoveis/comercial')) ? 'active' : '' !!}"><a href="{!! route('properties-type', ['comercial']) !!}"><i class="fas fa-city"></i>Tipos Comerciais</a></li>
            <li class="{!! (request()->is('admin/tipos-imoveis/residencial')) ? 'active' : '' !!}"><a href="{!! route('properties-type', ['residencial']) !!}"><i class="fas fa-hotel"></i>Tipos Residenciais</a></li>
        </ul>
        <ul>

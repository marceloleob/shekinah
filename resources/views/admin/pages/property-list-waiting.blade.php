...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="inner_title mb-4">Imóveis Pendentes</h4>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <table class="property_list">
                <thead>
                    <tr>
                        <td>Propriedades</td>
                        <td class="center" width="30%">Pendência</td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="{!! route('properties-form', [$item->id, $data->currentPage()]) !!}" class="edit"><i class="fas fa-pencil-alt"></i> Editar</a>
                            <a href="{!! route('properties-form', [$item->id, $data->currentPage()]) !!}" class="check"><i class="far fa-check-circle"></i> Analisar</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

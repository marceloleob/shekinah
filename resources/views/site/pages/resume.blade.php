...
<head>
	...
	{{-- CSS --}}
	{!! Html::style('css/resume/style.css') !!}
</head>
        ...
        <article class="resume-wrapper mx-auto theme-bg-light p-5 mb-5 my-5 shadow-lg">
            ...
            <div class="resume-intro py-3">
                <div class="media flex-column flex-md-row align-items-center">
                    <img class="resume-profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto" src="{!! asset('images/resume/marcelo.png') !!}" alt="image">
